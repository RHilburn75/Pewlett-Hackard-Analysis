...
-- List of retirement-eligible employees
SELECT first_name,
...
-- Just checking what the table returns
SELECT * FROM retirement_info;

-- Dropping the table to redo the table properly to include needed columns
...
-- SQL allows developers to give nicknames to tables.
...
SELECT COUNT(ce.emp_no),
       de.dept_no INTO retirement_info_dept
FROM current_emp as ce
LEFT JOIN dept_emp as de ON ce.emp_no = de.emp_no
GROUP BY de.dept_no
ORDER BY de.dept_no;

-- Checking the shape of the salaries table
